        ...
        <div className='h-full bg-primary/30 py-32 text-center xl:text-left'>
            ...
            <div className='container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6'>
                <div className='flex-1 flex flex-col justify-center'>
                    ...
                    >10 years ago, I began freelancing as a developer. Since then, I've done remote work for agencies,
                    ...
                    >
                        <div className='flex flex-1 xl:gap-x-6'>
                            <Achievement counterValue={10} text='Years of experience' border/>
                            <Achievement counterValue={250} text='Satisfied clients' border/>
                            <Achievement counterValue={650} text='Finished projects' border/>
